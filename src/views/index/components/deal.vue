    ...
    <div class="deal-list" v-show="tabMenu === 1">
      <div class="content-box" v-for="(item, index) in idoList" :key="index">
        <div class="commodity-box">
          ...
          <div class="commodity-column">
            <p class="shop-box">
              <f7-button class="shop-btn" :disabled="userinfo.status !== 'stop' || true" @click="usdtApproved ? transferUsdt(item.type, false) : usdtApprove()" :loading="loading" fill>{{lang('单币购买')}}</f7-button>
